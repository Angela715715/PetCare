...
public class AddWeightRecordUI extends JFrame {
    private static final long serialVersionUID = 1L;
    private Pet pet;
    private JPanel contentPane;
    private DatePickerField weightDateField;
    private JTextField weightKgField;
    private JTextField noteField;

    public AddWeightRecordUI() {
        this(createDemoPet());
    }

    public AddWeightRecordUI(Pet pet) {
        this.pet = pet;
        initialize();
    }

    private void initialize() {
        setTitle("PetCare 新增體重紀錄");
        ...
        JLabel breadcrumbLabel = new JLabel("我的寵物 / 寵物詳細 / 新增體重紀錄");
        ...
        JLabel titleLabel = new JLabel("新增體重紀錄");
        ...
        JLabel weightDateLabel = new JLabel("日期 *");
        weightDateLabel.setFont(ModernUI.BUTTON_FONT);
        weightDateLabel.setForeground(ModernUI.BLACK);
        weightDateLabel.setBounds(70, 125, 180, 24);
        card.add(weightDateLabel);

        weightDateField = new DatePickerField(70, 155, 250, 38);
        card.add(weightDateField);
        JLabel weightKgLabel = new JLabel("體重 kg *");
        weightKgLabel.setFont(ModernUI.BUTTON_FONT);
        weightKgLabel.setForeground(ModernUI.BLACK);
        weightKgLabel.setBounds(385, 125, 180, 24);
        card.add(weightKgLabel);

        weightKgField = ModernUI.textField(385, 155, 250, 38);
        card.add(weightKgField);
        JLabel noteLabel = new JLabel("備註");
        noteLabel.setFont(ModernUI.BUTTON_FONT);
        noteLabel.setForeground(ModernUI.BLACK);
        noteLabel.setBounds(70, 220, 180, 24);
        card.add(noteLabel);

        noteField = ModernUI.textField(70, 250, 595, 38);
        card.add(noteField);
    ...
    private void save() {
        try {
            ...
            record.setWeightDate(parseDate(weightDateField.getText(), true));
            record.setWeightKg(Double.parseDouble(weightKgField.getText().trim()));
